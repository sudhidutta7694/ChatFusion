...
import { Check, Gavel, Loader2, MoreVertical, Shield, ShieldCheck, ShieldPlus, ShieldQuestion } from "lucide-react";
...
const RoleIconMap = {
    "GUEST": <Shield className="h-4 w-4 ml-2 text-blue-500" />,
    "MODERATOR": <ShieldCheck className="h-4 w-4 ml-2 text-indigo-500" />,
    "ADMIN": <ShieldPlus className="h-4 w-4 ml-2 text-green-500" />
}
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent side="left" className="h-20">
                                            ...
                                            <DropdownMenuSeparator>
                                                ...
                                                >
                                                    <Gavel className="h-4 w-4 mr-2 ml-[0.3rem]" />
                                                    Kick
                                                </DropdownMenuItem>
                                            </DropdownMenuSeparator>
                                        </DropdownMenuContent>
